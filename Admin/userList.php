        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
                <div>
                  <a href="userAdd.php" type="button" class="btn btn-success">New User</a>
                </div><br>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="btn-group">
                          ...
                          <div class="container"> 
                            <a href="userDelete.php?id=<?php echo $value['id'];?>" type="button" class="btn btn-danger" onclick="return confirm('Are you sure want to delete?')">Delete</a>
                          </div>
                        </div>
                      </td>
                    </tr>
